...
if (!empty($search)) {
    $sql .= " WHERE nama_tim LIKE '%$search%' OR game LIKE '%$search%'";
}
...
<body>
    <main class="data-lomba-section">
        ...
        <form method="GET" action="" class="search-form">
            <input type="text" name="search" placeholder="Cari berdasarkan nama tim atau game..." value="<?= isset($_GET['search']) ? h($_GET['search']) : '' ?>">
